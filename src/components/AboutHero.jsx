...
import heroVideo from "../assets/work4.mp4";
...
const AboutHero = () => {
  return (
    <section className="relative flex min-h-screen w-full flex-col overflow-hidden bg-gunmetal">
      {/* Background video — matching Hero.jsx's treatment */}
      <video
        src={heroVideo}
        autoPlay
        loop
      ...
      {/* Nav — identical to Hero.jsx so it's consistent across routes */}
      ...
      {/* Page title — same outlined-serif treatment as the homepage wordmark, but reads as a page header, not a duplicate logo */}
